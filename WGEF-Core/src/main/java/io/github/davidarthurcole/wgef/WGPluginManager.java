...
import io.github.davidarthurcole.wgef.abstraction.IManager;
...
import io.github.davidarthurcole.wgef.abstraction.flags.handler.command.CommandOnEntryHandler;
import io.github.davidarthurcole.wgef.abstraction.flags.handler.command.CommandOnExitHandler;
import io.github.davidarthurcole.wgef.abstraction.flags.handler.command.ConsoleCommandOnEntryHandler;
import io.github.davidarthurcole.wgef.abstraction.flags.handler.command.ConsoleCommandOnExitHandler;
import io.github.davidarthurcole.wgef.abstraction.flags.handler.essentials.GodModeHandler;
import io.github.davidarthurcole.wgef.abstraction.flags.handler.player.*;
import io.github.davidarthurcole.wgef.abstraction.flags.handler.teleport.TeleportEntryHandler;
import io.github.davidarthurcole.wgef.abstraction.flags.handler.teleport.TeleportExitHandler;
...
public class WGPluginManager implements IManager {
    ...
    public void load() {
        ...
        registry.register(WGEFlags.DENY_SPAWN_EGG_SPAWN);
        registry.register(WGEFlags.DENY_SPAWN_EGG_SPAWNER);
    ...
    private void updateChecker() {
        ...
        new UpdateChecker(this.plugin, 96894)
                .getVersion(version -> {
                    if (plugin.getDescription().getVersion().equals(version) || true) { // I ain't messing with this shit man
